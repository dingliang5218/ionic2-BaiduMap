...
export class ContactPage {
  ...
  selectAllData(){
    ...
    this.linechart.setOption(baseOption, true);
    this.linechart.resize({width: window.innerWidth - 32});
    ...
    this.ringchart.resize({width: window.innerWidth - 32});
    ...
    this.columnchart.setOption(columnoption);
    this.columnchart.resize({width: window.innerWidth - 32});
  }
}
